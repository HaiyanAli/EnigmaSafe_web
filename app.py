...
from EnigmaSave import EnigmaSafe
    ...
    if 'username' in session:
        if request.method == 'GET':
            ...
            if data == False:
                ...
                return jsonify({'success': 'Password Copyed!','error': '', 'password':f'<input type="text"  id="t4_inp" value="{data}">'})
